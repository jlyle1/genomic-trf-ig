# Home - Genomic Test Requisition Form (TRF) Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://example.org/fhir/uv/genomic-trf/ImplementationGuide/genomic-trf | *Version*:0.1.0 |
| Draft as of 2026-08-17 | *Computable Name*:GenomicTRFIG |
...
```json
{
  ...
  "id" : "genomic-trf",
  "url" : "https://example.org/fhir/uv/genomic-trf/ImplementationGuide/genomic-trf",
  "version" : "0.1.0",
  "name" : "GenomicTRFIG",
  "title" : "Genomic Test Requisition Form (TRF) Implementation Guide",
  "status" : "draft",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://example.org/fhir/uv/genomic-trf/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-genomic-test-order.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/genomic-test-order"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-genomic-trf-order-category.html"
      }],
      "reference" : {
        "reference" : "CodeSystem/genomic-trf-order-category"
      },
      "name" : "Genomic TRF Order Category",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-genomic-trf-order-category.html"
      }],
      "reference" : {
        "reference" : "ValueSet/genomic-trf-order-category"
      },
      "name" : "Genomic TRF Order Category ValueSet",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-genomic-trf-questionnaire-response.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/genomic-trf-questionnaire-response"
      },
      "name" : "Genomic TRF Questionnaire Response",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-genomic-trf-specimen.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/genomic-trf-specimen"
      },
      "name" : "Genomic TRF Specimen",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-genomic-trf-study.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/genomic-trf-study"
      },
      "name" : "Genomic TRF Study",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Bundle-genomic-test-order-trf-example.html"
      }],
      "reference" : {
        "reference" : "Bundle/genomic-test-order-trf-example"
      },
      "name" : "genomic-test-order-trf-example",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-order-detail-parameter.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/order-detail-parameter"
      },
      "name" : "Order Detail Parameter (R6 Pre-adoption)",
